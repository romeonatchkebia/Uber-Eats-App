...
export const PHONE_INPUT_SCREEN = "PhoneInput";
export const PASSWORD_INPUT_SCREEN = "PassInput";
export const PHONE_VERIFICATION_SCREEN = "PhoneVerification";
export const EMAIL_VERIFICATION_SCREEN = "EmailVerification";
...
export const ORDERS_SCREEN = "PastOrders";
